// lib/services/vegetable_scanner_api.dart
...
class VegetableScannerAPI {
  ...
  // Enhanced Vegetable database with complete information and 3 types for each vegetable
  ...
  Future<Map<String, dynamic>?> getVegetableInfo(String key) async {
    ...
    // Return a copy of the vegetable data with scan count added
    return Map<String, dynamic>.from(vegetable)..['scan_count'] = scanCount;
  }

  // Get all vegetables with scan counts
